...
async function main() {
    ...
    microphoneButton.setAttribute('class', 'GPT-microphone-button absolute bg-white dark:border-gray-900/50 dark:text-white gizmo:dark:border-token-border-heavy gizmo:rounded-2xl dark:bg-gray-700 rounded-xl shadow-xs dark:shadow-xs shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)] gizmo:dark:bg-gray-800 gizmo:shadow-[0_0_0_2px_rgba(255,255,255,0.95)] gizmo:dark:shadow-[0_0_0_2px_rgba(52,53,65,0.95)] hover:bg-gray-100');
