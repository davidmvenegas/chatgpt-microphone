...
async function main() {
    ...
    microphoneButton.setAttribute('style', 'right: -67px; bottom: 0; height: 58px; width: 58px; display: flex; align-items: center; justify-content: center; border-width: 1px; margin-bottom: -1px;');
